...
const Benefit = () => {
    return (
        <div className='benefit bg-transparent  grid grid-cols-2 '>
          <div className='grid grid-cols-2 '>
          <div  data-aos="fade-right"    className='bg-black opacity-50   px-60 py-20'>
               <h1 className='text-white text-6xl font-samu'>Improves Cardiovascular Health</h1> 
            ...
            <div  data-aos="fade-left" className='bg-black opacity-50   px-60 py-20'>
               <h1 className='text-white text-6xl font-samu'>Builds Strength and Muscle Tone</h1> 
            ...
            <div  data-aos="fade-right" className='bg-black opacity-50   px-60 py-40'>
               <h1 className='text-white text-6xl font-samu'>Enhances Coordination and Balance</h1> 
            ...
            <div  data-aos="fade-left" className='bg-black opacity-50   px-60 py-40'>
               <h1 className='text-white text-6xl font-samu'>Burns Calories and Aids Weight Loss</h1> 
            ...
            <div  data-aos="fade-right" className='bg-black opacity-50   px-60 py-40'>
               <h1 className='text-white text-6xl font-samu'>Teaches Discipline and Self-Control</h1> 
            ...
            <div  data-aos="fade-left" className='bg-black opacity-50   px-60 py-40'>
               <h1 className='text-white text-6xl font-samu'>Provides  Self-Defense Skills</h1> 
